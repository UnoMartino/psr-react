const Admin = () => {
    return(
        <div className="flex flex-col items-center">
            <div className='font-baloo text-2xl text-zinc-200 font-normal mb-2'>Logowanie</div>
            <div className='font-baloo text-2xl text-zinc-200 font-normal mb-2'>Blacklista autorów</div>
