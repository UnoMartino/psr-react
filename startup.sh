...
if [ ! -e /data/$CONFIGURED ]; then
    ...
    python3 /data/backend.py $SPOTIFY_CLIENT_ID $SPOTIFY_CLIENT_SECRET $SPOTIFY_USERNAME $SPOTIFY_DESTINATION_PLAYLIST_ID $DB_HOST $DB_USER $DB_PASSWORD $DB_DATABASE
fi
